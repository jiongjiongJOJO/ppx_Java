...
public enum Prefs {
	...
	REMOVE_ITEM("pref_remove_item"),
	REMOVE_ITEM_KEYWORDS("pref_remove_item_keywords"),
	REMOVE_ITEM_USERS("pref_remove_item_users"),
	REMOVE_ITEM_OFFICIAL("pref_remove_item_official"),
	REMOVE_ITEM_PROMOTION("pref_remove_item_promotion"),
	REMOVE_AVATAR_DECORATION("pref_remove_avatar_decoration"),
	DISABLE_HISTORY_ITEMS("pref_disable_history_items"),
	USE_NEW_CATEGORY_LIST("pref_use_new_category_list"),
	DIY_CATEGORY_LIST("pref_diy_category_list"),
	MY_CHANNEL("pref_my_channel"),
	OTHER_CHANNEL("pref_other_channel"),
	MY_CHANNEL_NEW("pref_my_channel_new"),
	OTHER_CHANNEL_NEW("pref_other_channel_new"),
	...
	QUERY_DANMAKU_SENDER("pref_query_danmaku_sender"),
	SHOW_FEMALE_TIP("pref_show_female_tip"),
	MODIFY_INTERACTION_STYLE("pref_modify_interaction_style"),
	DIGG_STYLE("pref_digg_style"),
	DISS_STYLE("pref_diss_style"),
	SET_COLOR_COMMENT("pref_set_color_comment"),
	SET_COLOR_TYPE("pref_set_color_type"),
	SHOW_COMMENT_TIME("pref_show_exact_comment_time"),
	RECENT_COMMENT_TIME_FORMAT("pref_show_recent_comment_time_format"),
	...
	AUTO_DISS_ENABLE("pref_auto_diss_enable"),
	AUTO_DISS_PAUSE("pref_auto_diss_pause"),
	...
	AUTO_COMMENT_DIGG("pref_auto_comment_digg_enable"),
